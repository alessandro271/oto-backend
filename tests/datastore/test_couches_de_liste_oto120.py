...
def live(pg_dsn):
    """Un PostgreSQL RÉEL, jetable : c'est la BASE qu'il faut interroger pour savoir
    ce qui est tombé, jamais ce que l'appel a bien voulu répondre."""
    import os

    psycopg = pytest.importorskip("psycopg")
    from oto_mcp.db import _conn as dbconn

    name = "oto_c120_" + uuid.uuid4().hex[:8]
