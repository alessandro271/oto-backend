...
def register(mcp: FastMCP) -> None:
    ...
    def apollo_bulk_match(
        ...
        Args:
            ...
            full: keep each employer's tech stack, funding and keywords. Off by
                default: at 10 people those blocks alone run past 500 000
                characters, which no agent can read.
        """
