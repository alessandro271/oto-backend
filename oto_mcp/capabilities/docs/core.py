...
CAPABILITIES += [
    Capability(
        ...
        description=(
            ...
            "the page's own project, then the org's historical documents project (the one "
            "each org was seeded with, when it has one) — never any other project — "
            "case- and edge-space-insensitive; a title "
            ...
            "and they differ BOTH ways. (a) The graph is not symmetric: a page of that "
            "historical project resolves against it alone, so it can NEVER link to a page "
            "living in another project — while that other page links to it fine. A page "
