...
def refresh_links(conn, from_doc: int, project_id: int, body_md: str,
    ...
    if trace is not None and orphelines:
        ...
        trace["citations_sans_cible_hint"] = (
            ...
            "la résolution regarde ce projet puis le projet de documents "
            "historique de l'org (celui avec lequel l'org a été créée, si elle "
            "en a un) — et rien d'autre : depuis une page de ce projet "
            "historique, une page d'un autre projet est hors de portée. "
            "`op=backlinks` ne mesure PAS "
